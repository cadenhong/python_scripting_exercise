...
- If all the letters in the list are used inEnter your script below. Be sure to save a copy to compare with the response on the next screen. the string, the function should return an empty list (see example #3).
'''
